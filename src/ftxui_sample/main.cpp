...
// configuration step. It creates a namespace called `newCmakeTemplate`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", newCmakeTemplate::cmake::project_name, newCmakeTemplate::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", newCmakeTemplate::cmake::project_version);
      return EXIT_SUCCESS;
    }
